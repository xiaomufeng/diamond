...
public class Constants {
    ...
    public static final int POLLING_INTERVAL_TIME = 35;//15 秒,modified by macun.mc @2015/12/7
    ...
    public static final String CONFIG_HTTP_URI_FILE = "/diamond-server/url";
